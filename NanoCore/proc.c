...
PUBLIC int sys_sendrec(int function, int src_dest, MESSAGE* m, struct proc* p)
{
	...
	panic("[ERRO][Core]{sys_sendrec} invalid function: "
...
PUBLIC void dump_proc(struct proc* p)
{
	...
	sprintf(info, "[INFO]byte dump of proc_table[%d]:\n", p - proc_table); disp_color_str(info, text_color);
	...
	disp_color_str("\n\n", text_color);
	sprintf(info, "[INFO]ANY: 0x%x.\n", ANY); disp_color_str(info, text_color);
	sprintf(info, "[INFO]NO_TASK: 0x%x.\n", NO_TASK); disp_color_str(info, text_color);
	disp_color_str("\n", text_color);

	sprintf(info, "[INFO]ldt_sel: 0x%x.  ", p->ldt_sel); disp_color_str(info, text_color);
	sprintf(info, "[INFO]ticks: 0x%x.  ", p->ticks); disp_color_str(info, text_color);
	sprintf(info, "[INFO]priority: 0x%x.  ", p->priority); disp_color_str(info, text_color);
	/* sprintf(info, "pid: 0x%x.  ", p->pid); disp_color_str(info, text_color); */
	sprintf(info, "[INFO]name: %s.  ", p->name); disp_color_str(info, text_color);
	disp_color_str("\n", text_color);
	sprintf(info, "[INFO]p_flags: 0x%x.  ", p->p_flags); disp_color_str(info, text_color);
	sprintf(info, "[INFO]p_recvfrom: 0x%x.  ", p->p_recvfrom); disp_color_str(info, text_color);
	sprintf(info, "[INFO]p_sendto: 0x%x.  ", p->p_sendto); disp_color_str(info, text_color);
	/* sprintf(info, "nr_tty: 0x%x.  ", p->nr_tty); disp_color_str(info, text_color); */
	disp_color_str("\n", text_color);
	sprintf(info, "[INFO]has_int_msg: 0x%x.  ", p->has_int_msg); disp_color_str(info, text_color);
}
